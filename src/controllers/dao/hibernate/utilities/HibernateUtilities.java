...
public class HibernateUtilities {
    ...
    private HibernateUtilities() {
        ...
        // Mapping tables
        config.addAnnotatedClass(entity.customer.Customer.class);
        config.addAnnotatedClass(entity.address.Address.class);
        config.addAnnotatedClass(entity.estimate.Estimate.class);
        config.addAnnotatedClass(entity.estimate_item.EstimateItem.class);
        config.addAnnotatedClass(entity.telephone_number.TelephoneNumber.class);
